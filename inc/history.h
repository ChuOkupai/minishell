...
/*   Updated: 2020/09/30 17:18:51 by asoursou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
void	msh_history_init(t_history *history);

/*
** Clears command history.
*/
void	msh_history_clear(t_history *history);
...
*/
int		msh_history_add(t_history *history, const char *string);
...
** Returns -1 on error, else 0.
*/
int		msh_history_edit(t_history *history, const char *string, size_t i);

/*
** Sets a new size for the command history.
*/
void	msh_history_resize(t_history *history, size_t size);
